  ...
  if (req.method === "POST") {
    ...
    try {
      ...
      await loops.sendTransactionalEmail({
        transactionalId: process.env.LOOPS_WELCOME_EMAIL_ID, // Set this to your Loops transactional email ID
        email: email,
        addToAudience: true, // Optional, adds the user to your Loops audience
        dataVariables: {
          userEmail: email, // Pass any additional variables required by your Loops email template
          // Add any other placeholders defined in your Loops email
        },
      });
